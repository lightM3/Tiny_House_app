        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Puan Verin"),
              Wrap(
                // 📌 Yıldızları taşmasını engellemek için Wrap kullandık
                spacing: 5.0,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Wrap(
                          // 📌 Yıldızların taşmasını engellemek için Wrap kullanıldı
                          spacing: 3.0,
                          children: List.generate(5, (starIndex) {
                            return Icon(
                              Icons.star,
